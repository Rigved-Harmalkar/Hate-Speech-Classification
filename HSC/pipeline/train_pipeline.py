import sys
<<<<<<< HEAD:Hate/pipeline/train_pipeline.py
...
from HSC.components.data_ingestion import DataIngestion
...
from HSC.components.data_transformation import (DataTransformation)

from HSC.components.model_trainer import ModelTrainer
from HSC.components.model_evaluation import ModelEvaluation
from HSC.components.model_pusher import ModelPusher



>>>>>>> 5e0d9c7 (added transformation, evaluation and deployment using Fast API):HSC/pipeline/train_pipeline.py
